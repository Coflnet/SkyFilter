...
namespace Coflnet.Sky.Filter
{
    public class FilterEngine
    {
        ...
        public FilterEngine(INBT nBT)
        {
            ...
            Filters.Add<TunedTransmissionFilter>();
            // skins
            ...
            Filters.Add<DungeonSkillReqFilter>();
            ...
            Filters.TryAdd($"ultimate_duplex", new EnchantBaseFilter(Enchantment.EnchantmentType.ultimate_duplex, "ultimate_duplex", "ultimate_reiterate"));
            ...
            Filters.TryAdd($"gravity", new EnchantBaseFilter(Enchantment.EnchantmentType.dragon_hunter, "gravity", "dragon_hunter"));
            Filters.TryAdd($"drain", new EnchantBaseFilter(Enchantment.EnchantmentType.syphon, "drain", "gravity"));
        ...
        public async Task Load(IServiceProvider provider)
        {
            ...
            {
                if (!item.Tag.StartsWith("RUNE_") && !item.Tag.StartsWith("UNIQUE_RUNE_") || item.Name == null)
                    continue;
